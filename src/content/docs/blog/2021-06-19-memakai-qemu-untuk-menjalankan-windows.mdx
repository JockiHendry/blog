...
date: 2021-06-19
tags: [Ubuntu, QEMU]
excerpt: Untuk mengoptimalkan kinerja Android emulator, saya mengaktifkan KVM pada sistem operasi Ubuntu yang saya pakai. KVM adalah *hypervisor* yang terintegrasi pada kernel sistem operasi Linux...
...
```bash
qemu-img create -f raw win10-disk.img 150G
```
...
```bash
qemu-system-x86_64 -cpu host -smp cores=4 -enable-kvm -vga std -m 8G -cdrom Win10_21H1_English_x64.iso win10-disk.img
```
...
![Menggunakan Remmina Untuk Terhubung Ke QEMU](../../../assets/gambar_20210619_001.png)
