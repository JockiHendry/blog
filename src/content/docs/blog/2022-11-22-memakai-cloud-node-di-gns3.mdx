...
date: 2022-11-22
tags: [GNS3]
excerpt: Cloud node adalah salah satu fitur yang sangat berguna di GNS3.  Dengan *cloud node* tersebut, saya dapat menghubungkan jaringan yang disimulasikan ke jaringan lainnya yang berada di luar GNS3 seperti Internet, perangkat virtual, termasuk dengan jaringan di simulasi proyek GNS3 lainnya...
---
...
![Terhubung Ke Internet](../../../assets/gambar_20221122_001.png)
...
![Menampilkan Perangkat Virtual](../../../assets/gambar_20221122_002.png)
...
![Server NGINX di GNS3](../../../assets/gambar_20221122_003.png)
...
```shell
docker run -p 192.168.122.1:80:80 --name nginx ubuntu/nginx:latest
```

Setelah itu, saya akan membuat topologi seperti pada gambar berikut ini:

![Mengakses server NGINX di host](../../../assets/gambar_20221122_004.png)
...
![Konfigurasi UDP tunnel di proyek pertama](../../../assets/gambar_20221122_005.png)
...
![Proyek dengan server NGINX](../../../assets/gambar_20221122_006.png)
...
![Proyek client](../../../assets/gambar_20221122_008.png)

Pada `PC1`, saya kemudian memberikan perintah seperti berikut ini:

```shell
ip address add 192.168.44.56/24 dev eth0
curl http://192.168.44.55
```
...
```shell
ip address add 192.168.44.57/24 dev eth0
curl http://192.168.44.55
```
