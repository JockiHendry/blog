...
date: 2021-11-17
tags: [Ubuntu]
excerpt: Pada suatu hari, saya ingin melakukan konfigurasi sederhana di *server* Ubuntu.  Saya ingin mengubah yang sebelumnya menggunakan DHCP menjadi alamat statis dan memakai DNS yang saya tentukan...
---
...
:::caution
Cara ini tidak berlaku lagi di Ubuntu modern.  Perubahan pada file konfigurasi di bawah ini akan diabaikan atau ditulis ulang pada saat status jaringan berubah. 
:::
...
```properties title="dns-servers.conf"
[global-dns-domain-*]
