...
Saya kemudian menambahkan sebuah *function* di *struct* tersebut untuk mengirim pesan STUN seperti yang saya lakukan di di [artikel sebelumnya](./2023-09-06-apa-itu-protokol-stun):
...
![Respon Untuk Paket Pertama](../../../assets/gambar_20230924_001.png)

Saya perlu memastikan bahwa jenis kesalahan di atribut `ERROR-CODE` adalah `0x0401` yang berarti `Unauthorized`.  Setelah yakin,
