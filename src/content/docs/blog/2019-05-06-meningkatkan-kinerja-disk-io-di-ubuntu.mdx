...
date: 2019-05-06
tags: [Ubuntu]
excerpt: Saat menggunakan *external HDD* untuk bekerja, saya menemukan bahwa Ubuntu bekerja jauh lebih lambat dibandingkan saat menggunakan *internal HDD*.  Hal ini terutama sangat terasa bila saya menjalankan beberapa IDE sekaligus seperti Webstorm dan IntelliJ IDEA secara bersamaan...
...
```text title="fstab" "commit=30"
UUID=xxx /               ext4    errors=remount-ro,noatime,commit=30 0       1
```
