...
excerpt: Walaupun situs ini adalah sebuah situs statis, saat mencobanya secara offline, saya menemukan sebuah masalah.  Setelah cache kadaluarsa, browser berusaha menarik file dari CDN seperti Bootstrap, Highcharts dan sebagainya...
tableOfContents: false
---

:::caution
Ini adalah artikel lama yang sudah tidak relevan lagi.  Blog ini sudah beralih dari Jekyll ke Astro.
:::
...
![Daftar service worker di Chrome developer tools](../../../assets/gambar_20180520_001.png)
...
![Resource yang diambil melalui service worker](../../../assets/gambar_20180520_002.png)
...
![Daftar cache di Chrome developer tools](../../../assets/gambar_20180520_003.png)
