...
excerpt: Pada awalnya, JavaScript tidak memiliki konsep *module*... Konsep *module*-pun mulai diperkenalkan secara tidak resmi seperti Asynchronous Module Definition (AMD), CommonJS, Node.js modules, SystemJS dan Universal Module Definition (UMD) dan  ES6 pada akhirnya memperkenalkan keyword `export` dan `import` untuk mendukung *module* secara resmi...
