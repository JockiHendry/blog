...
date: 2021-12-14
tags: [Architecture, GCP, Kubernetes, Docker, Firebase, Spring Framework, ELK, Authentication]
excerpt: Disaat saya harus merancang aplikasi dari nol, saya sudah punya beberapa setelan standar. Pada artikel ini, saya akan membahas dua arsitektur di benak saya, Kubernetes native dan cloud native...
---
...
![Arsitektur latihan-k8s](../../../assets/gambar_20211214_001.png)
...
![Men-*build* Dockerfile langsung ke minikube dari Webstorm](../../../assets/gambar_20211214_002.png)
...
![Login](../../../assets/gambar_20211214_003.png)
...
![Pencarian Dengan Elasticsearch](../../../assets/gambar_20211214_004.png)

Sebenarnya akses Elasticsearch langsung dari *front end* tidak disarankan.  Walaupun demikian, saran ini boleh dilanggar bila saya menggunakan *ingress controller* atau API Gateway yang mampu melakukan terminasi HTTPS, validasi JWT (*authorization*), pembatasan *request* dan *path* (misalnya tidak mengizinkan request dengan method `DELETE` yang akan menghapus database), dan sebagainya.
...
![Menambah Item Baru Dengan Pola CQRS](../../../assets/gambar_20211214_005.png)
...
![Arsitektur latihan-cloud-native](../../../assets/gambar_20211214_006.png)
...
![Halaman Login](../../../assets/gambar_20211214_007.png)
...
![Halaman Pencarian Item](../../../assets/gambar_20211214_008.png)
...
**Pemenang**:  [latihan-k8s](https://github.com/JockiHendry/latihan-k8s/tree/9c52f787aa50d0020b6db7944c6f1fade40127c0) - akses dibatasi *ingress controller*, data tetap berada di dalam *cluster* Kubernetes selama saya tidak mengirimnya ke *service* luar.