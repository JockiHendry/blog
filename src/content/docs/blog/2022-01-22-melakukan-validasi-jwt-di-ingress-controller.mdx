...
```yaml title="ingress-file-read.yaml"
apiVersion: networking.k8s.io/v1
kind: Ingress
metadata:
...
```yaml title="ingress-file-write.yaml"
apiVersion: networking.k8s.io/v1
kind: Ingress
metadata:
