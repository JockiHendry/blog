...
date: 2021-12-30
tags: [OCR, Docker, ELK]
excerpt: John menggunakan library FSCrawler untuk menerapkan OCR pada file gambar...
...
```bash
docker compose run fscrawler fscrawler
```
...
```bash
docker compose run fscrawler fscrawler jessica
```
...
![Dokumen Elasticsearch Di Kibana](../../../assets/gambar_20211230_001.png)
...
![Tag cloud dengan Terms](../../../assets/gambar_20211230_002.png)
...
![Terms versus Significant Terms](../../../assets/gambar_20211230_003.png)
