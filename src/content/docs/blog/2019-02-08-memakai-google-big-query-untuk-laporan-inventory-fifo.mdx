...
excerpt: Menghitung data untuk laporan inventory berbasis FIFO sebenarnya tidak kompleks.  Saya hanya perlu mengetahui jumlah item yang tersisa, lalu mencari transaksi pembelian dan retur terbaru hingga mencapai nilai jumlah item tersisa.  Sama sekali tidak perlu menghitung penjualan dan transaksi lainnya...
...
```typescript title="slow_calculation.ts"
...
![Mengerjakan Query Secara Interaktif Di BigQuery](../../../assets/gambar_20190208_001.png)
