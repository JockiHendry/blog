...
date: 2022-11-26
tags: [Ubuntu, OpenVPN]
excerpt: Salah satu metode yang paling umum dipakai untuk menghubungkan dua jaringan di lokasi fisik yang berbeda melalui Internet adalah dengan mengunakan VPN.  Dengan menambahkan VPN gateway, masing-masing perangkat lokal di jaringan berbeda dapat saling berkomunikasi seolah-olah mereka terhubung secara lokal di jaringan yang sama...
---
...
![Topologi Jaringan Awal](../../../assets/gambar_20221126_001.png)
...
![Topologi Jaringan Dengan VPN Gateway](../../../assets/gambar_20221126_002.png)
...
```properties title="isc-dhcp-server"
INTERFACESv4="ens5"
INTERFACESv6="ens5"
```
...
Walaupun sederhana dan tepat untuk percobaan sederhana seperti di tulisan ini, hasil dari perintah di atas tidak permanen sehingga saya perlu memberikan perintah yang sama setiap kali menjalankan ulang topologi.  

Berikutnya, saya akan melakukan konfigurasi OpenVPN.  Karena `ovpn-server` akan menjadi server OpenVPN, saya membuat file konfigurasi OpenVPN dengan nama `server.ovpn` yang memiliki isi seperti berikut ini:

```text title="server.ovpn"
dev tun
local 192.168.1.196
