...
date: 2018-05-17
tags: [Ubuntu]
excerpt: Keyboard yang saya pakai memiliki *backlit* (pencahayaan) yang dapat dinyalakan dan dimatikan melalui tombol Scroll Lock.  Sama sekali tidak ada masalah pada saat saya mencobanya di Windows.  Akan tetapi, saat menggunakan keyboard yang sama di Ubuntu, tombol Scroll Lock seolah-olah tidak bekerja...
