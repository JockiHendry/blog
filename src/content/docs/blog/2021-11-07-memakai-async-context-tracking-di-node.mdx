...
excerpt: AsyncLocalStorage adalah class bawaan Node (terletak di modul `async_hooks`) yang dapat digunakan untuk memberikan *context* pada eksekusi operasi *asynchronous* dan juga semua operasi *asynchronous* yang dipanggil oleh operasi tersebut...
