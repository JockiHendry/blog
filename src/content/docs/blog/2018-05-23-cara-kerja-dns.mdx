...
date: 2018-05-23
tags: [DNS]
excerpt:  Mengapa sebuah website memiliki alamat seperti `www.latihan.com`?  Apa artinya `www` dan `com`?
---
...
```text {"1":29-35} {"2":38} {"3":41-42} {"4":46-47}
  ; Domain: xyzxyz.xyz
...
```bash
dig @8.8.8.8 +trace -4 xyzxyz.xyz
```
...
```bash
dig @a.root-servers.net xyzxyz.xyz
```
