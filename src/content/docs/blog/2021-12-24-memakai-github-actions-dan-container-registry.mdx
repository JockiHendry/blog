...
date: 2021-12-24
tags: [Docker, Kubernetes, Spring Framework]
excerpt: Pada tulisan ini, saya akan mencoba menggunakan Github Actions sebagai CI platform untuk menghasilkan *image* Docker dan mempublikasikannya di GitHub Packages sehingga dapat saya pakai di *cluster* Kubernetes nantinya...
...
![Tab Actions Di GitHub](../../../assets/gambar_20211224_001.png)
...
```bash
docker pull ghcr.io/jockihendry/latihan-k8s-angular-web:edge
```
...
![Tampilan Di GitHub Packages](../../../assets/gambar_20211224_002.png)
...
```yaml title="stock-item-service.yaml"
