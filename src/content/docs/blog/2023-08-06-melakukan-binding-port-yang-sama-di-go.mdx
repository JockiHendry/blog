...
date: 2023-08-06
tags: [Go]
excerpt:  Sebuah *socket* di sistem operasi berbasis UNIX adalah kombinasi dari alamat IP sumber, port sumber, alamat IP tujuan dan port tujuan.  Pada umumnya, bila sebuah program ingin membuat *socket* baru, kombinasi dari ke-empat elemen tersebut harus unik.  Bagaimana bila aplikasi perlu menggunakan ulang *socket* yang sama?
