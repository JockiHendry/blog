...
excerpt: Satu hal yang masih kurang pada contoh di repository GitHub tersebut adalah *unit testing*.  Sebagai programmer yang mengikuti filosofi *agile*, saya selalu membuat *unit test* di semua proyek yang saya tulis...
...
![Melakukan inspeksi pada saat debugging](../../../assets/gambar_20190101_002.png)
...
```typescript title="AbstractTestBase.ts"
...
```typescript title="stock.spec.ts"
...
![Pengaturan Mocha Secara Global](../../../assets/gambar_20190101_003.png)
...
![Hasil pengujian di Webstorm](../../../assets/gambar_20190101_004.png)