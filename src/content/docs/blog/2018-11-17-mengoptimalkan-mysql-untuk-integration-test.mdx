...
date: 2018-11-17
tags: [MySQL]
excerpt: Bagaimana cara mengoptimalkan database MySQL yang dipakai untuk keperluan *integration testing* dimana reliabilitas boleh dikorbankan demi kecepatan?
...
![Tampilan Performance Dashboard di MySQL Workbench](../../../assets/gambar_20181117_001.png)
...
:::note
Pada sistem operasi Ubuntu, file konfigurasi MySQL 5.7 terletak di lokasi `/etc/mysql/mysql.conf.d/mysqld.cnf`.
:::
